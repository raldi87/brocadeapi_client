require_relative 'client'
 ...
 cl = BrocadeAPIClient::Client.new('https://dcfm.office.orange.intra/rest')
 cl.login('radud','radud')
# radu2= cl.resourcegroups
#  puts "ressource groups #{radu2}"
#  radu= cl.fabric('10:00:50:EB:1A:A8:2C:54')
# radu3 = cl.fabrics
# puts "fabrics #{radu3}"
#  radu = cl.fabricswitches('10:00:00:27:F8:F7:61:00')
  radu = cl.allswitches
